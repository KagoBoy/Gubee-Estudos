...
public class Order implements Serializable{
    ...
    @ManyToOne //Annotation para informar que a relação com cliente é de muitos para um
    @JoinColumn(name = "client_id") //seta o nome da chave estrangeira no banco de dados
    private User client;
