...
public class AccountLookupController {
    ...
    public ResponseEntity<AccountLookupResponse> getAllAccounts(){
        try {
            ...
            var safeErrorMessage = "Failed to complet get all accounts request!";
    ...
    public ResponseEntity<AccountLookupResponse> getAccountById(@PathVariable(value = "id") String id){
        ...
        try {
            ...
            var safeErrorMessage = "Failed to complet get account by ID request!";
            logger.log(Level.SEVERE, safeErrorMessage, e);
            return new ResponseEntity<>(new AccountLookupResponse(safeErrorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<AccountLookupResponse> getAccountByHolder(@PathVariable(value = "accountHolder") String accountHolder){
        try {
            ...
            var safeErrorMessage = "Failed to complet get account by holder request!";
            logger.log(Level.SEVERE, safeErrorMessage, e);
            return new ResponseEntity<>(new AccountLookupResponse(safeErrorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    @PathVariable(value = "balance") double balance){
        try {
            ...
            var safeErrorMessage = "Failed to complet get accounts with balance request!";
            logger.log(Level.SEVERE, safeErrorMessage, e);
            return new ResponseEntity<>(new AccountLookupResponse(safeErrorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
